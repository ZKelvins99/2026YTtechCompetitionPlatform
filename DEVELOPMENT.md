...
| 类型 | 路径 |
|---|---|
| 建表 | `crm_user_profile` 已在 `SQL/01_init_tables.sql` |
| 后端 Service | `CrmUserProfileServiceImpl.java` + `CrmProfileRefreshHelper.java` |
| 后端 Controller | `CrmUserProfileController.java` |
| SQL 菜单 | `SQL/08_crm_profile_menu.sql` |
